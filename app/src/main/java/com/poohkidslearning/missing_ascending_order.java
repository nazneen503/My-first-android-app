...
public class missing_ascending_order extends AppCompatActivity {
Toolbar toolbar;
TextView texttitle;
...
RecyclerView recycler,recycler1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_missing_ascending_order);
        ...
        toolbar.setBackgroundColor(Color.parseColor("#30359C"));
        texttitle.setText(" ASCENDING ORDER");
        Window window=getWindow();
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            window.setStatusBarColor(Color.parseColor("#30359C"));
        }
    ...
    private void getNumber() {
        ...
        dBhelper.openDB();
        arrayList=dBhelper.getNumber(0);
...
//        arrHint=arrChar;
        ...
        missing_asc_recycler_adapter adapter=new missing_asc_recycler_adapter(this,arrChar,arrBlanks);
        ...
        missing_ascending_recycler_adapter adapterHint=new missing_ascending_recycler_adapter(this,arrHint,arrChar, arrBlanks);
